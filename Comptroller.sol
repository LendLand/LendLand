...
/**
 * @title Lendland's Comptroller Contract
 * @author Lendland
 */
contract Comptroller is ComptrollerV4Storage, ComptrollerInterface, ComptrollerErrorReporter, Exponential {
    ...
    function _setCompRate(uint compRate_) public {
        require(adminOrInitializing(), "only admin can change Lend rate");
    ...
    function _addCompMarkets(address[] memory cTokens) public {
        require(adminOrInitializing(), "only admin can add Lend market");
    ...
    function _addCompMarketInternal(address cToken) internal {
        ...
        require(market.isComped == false, "Lend market already added");
    ...
    function _dropCompMarket(address cToken) public {
        require(msg.sender == admin, "only admin can drop Lend market");

        Market storage market = markets[cToken];
        require(market.isComped == true, "market is not a Lend market");
    ...
    function getCompAddress() public view returns (address) {
        return 0x1589992c28120C8981C7360edbC7f68640718689;
    }
}
