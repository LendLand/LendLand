...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV1, GovernorBravoEvents {
    ...
    string public constant name = "LendLand Governor Bravo";
    ...
    function initialize(address timelock_, address comp_, uint votingPeriod_, uint votingDelay_, uint proposalThreshold_) public {
        ...
        require(comp_ != address(0), "GovernorBravo::initialize: invalid Lend address");
    ...
    /**
     * @notice Admin function for setting the timelock admin
     */
    function __acceptAdmin() public {
        require(msg.sender == admin, "GovernorAlpha::__acceptAdmin: sender must be admin");
